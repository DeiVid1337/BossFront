...
/**
 * Seller Stock Edit View
 * Página para sellers editarem o estoque de um produto específico
...
async function loadStoreProduct() {
  ...
  try {
    ...
    stockQuantity.value = product.stock_quantity || 0
...
<template>
  <div class="seller-stock-edit-page">
